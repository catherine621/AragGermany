...
const TaxForm1 = () => {
  ...
  return (
    <div className="form-container">
              <h2 className="m">Tax Form for Person not Maried and Migrant </h2>
      ...
      <div className="section">
        ...
        <h3 className="l">Only fill if tax office does not have the corresponding notification authorization</h3>
        {[ 
